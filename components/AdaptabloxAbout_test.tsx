...
export default function AdaptabloxFAQs() {
  ...
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative size-full min-h-screen" data-name="adaptablox - faqs" data-node-id="1:163" style={{ background: "radial-gradient(66.15% 98.68% at -6.3% -5.34%, #F1F2F4 0%, #D7D9DF 100%)" }}>
      ...
      <div className="bg-[#eef0f4] content-stretch flex flex-col gap-[48px] items-start p-[36px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[900px] max-w-full mt-[103px] mb-12 mx-auto" data-node-id="1:200">
        <div className="content-stretch flex flex-col gap-[12px] items-start pb-[12px] pt-0 px-[24px] relative shrink-0 w-full" data-node-id="1:201">
        ...
        <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-node-id="1:204">
          ...
          <div className="content-start flex flex-wrap gap-[16px_24px] items-start justify-center relative shrink-0 w-full" data-node-id="1:209">
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-node-id="1:210">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:214">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:218">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:222">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:226">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:230">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:234">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:238">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:242">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:246">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:250">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:254">
        ...
        <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-node-id="1:258">
          ...
          <div className="content-start flex flex-wrap gap-[16px_24px] items-start justify-center relative shrink-0 w-full" data-node-id="1:263">
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:264">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:268">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:272">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:276">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:280">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[8px] shadow-[3px_6px_15px_0px_rgba(0,0,0,0.12)] shrink-0 w-[250px] h-[320px] bg-white" data-faq-card data-node-id="1:284">
