  ...
  class AxOutcomes extends AxWidget {
    ...
    css() {
      return (
        ...
        ".gate{position:absolute;left:50%;top:50%;width:5px;height:112px;transform:translate(-50%,-50%);" +
        "box-sizing:border-box;border:1px solid rgba(139,148,168,.38);" +
        "background:repeating-linear-gradient(45deg,#D4DAE3 0px,#D4DAE3 4px,#AEB5BF 4px,#AEB5BF 8px);" +
        "background-size:11.313px 11.313px;z-index:6;pointer-events:none}" +
        ":host([theme='light']) .gate{background:repeating-linear-gradient(45deg,#fff 0px,#fff 4px,#D8DEE6 4px,#D8DEE6 8px);" +
        ...
        ".human.hit{filter:drop-shadow(0 0 8px rgba(138,176,213,.95)) drop-shadow(0 0 16px rgba(138,176,213,.55))}" +
  ...
  class AxReceipt extends AxWidget {
    ...
    css() {
      return (
        ...
        "background:linear-gradient(175deg,rgba(var(--ar),.06),rgba(var(--wr),.015)),var(--frame-bg);" +
        "font-family:var(--mono);font-size:10.5px;z-index:2}" +
        ...
        ".sig{padding:7px 15px 8px;background:linear-gradient(180deg,rgba(var(--ar),.06),rgba(var(--ar),.02)),var(--frame-bg)}" +
        ...
        ":host([theme='light']) .rc{background:linear-gradient(175deg,rgba(var(--ar),.04),rgba(255,255,255,.92)),#fff;" +
        "border-color:rgba(var(--ar),.22);box-shadow:0 2px 10px rgba(var(--wr),.07)}" +
        ":host([theme='light']) .rc .sig{background:linear-gradient(180deg,rgba(var(--ar),.03),rgba(var(--ar),.01)),#fafbfc}"
      );
    }
    html() {
      return (
  ...
  class AxSequence extends AxWidget {
    ...
    css() {
      return (
        ...
        ".hold-bar{position:absolute;width:5px;transform:translateX(-50%);" +
        "box-sizing:border-box;border:1px solid rgba(139,148,168,.38);" +
        "background:repeating-linear-gradient(45deg,#D4DAE3 0px,#D4DAE3 4px,#AEB5BF 4px,#AEB5BF 8px);" +
